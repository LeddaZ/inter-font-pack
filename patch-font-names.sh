...
replace_name "Inter Variable" "Roboto" Roboto-Regular.ttx
replace_name "Inter Variable" "Roboto" RobotoStatic-Regular.ttx
replace_name "Inter Variable" "Google Sans" GoogleSans-*.ttx
